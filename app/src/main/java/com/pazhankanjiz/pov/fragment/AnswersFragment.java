...
import com.pazhankanjiz.pov.adapter.ProfileAnswerAdapter;
...
public class AnswersFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.answers_recycler_view);

        ProfileAnswerAdapter adapter = new ProfileAnswerAdapter(getContext(), Arrays.asList(
                new ProfileAnswerModel(R.drawable.ic_home_black_24dp, "abc"), new ProfileAnswerModel(R.drawable.ic_notifications_black_24dp, "cde")
        ));
